# 🛡️ Audi's InfoSec Command Center
...
- [ ] Memorize the CPU Fetch-Decode-Execute Cycle
- [ ] Explain the difference between Volatile (RAM) and Non-Volatile (SSD) memory
- [ ] Break down Lossless vs. Lossy data compression math

#### 🌐 Phase 2: Networks & Web Architecture
- [ ] Master the core difference between Circuit Switching and Packet Switching
- [ ] Explain how TCP/IP handshakes protect data packets across the internet
- [ ] Trace a Domain Name System (DNS) request from browser to IP address
- [ ] Understand the CIA Triad (Confidentiality, Integrity, Availability)

#### 🥷 Phase 3: Defensive Countermeasures
